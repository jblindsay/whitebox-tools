...
impl And {
    pub fn new() -> And { // public constructor
        let name = "And".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description = "Performs a logical AND operator on two Boolean raster images.".to_string();
        ...
        let usage = format!(">>.*{0} -r={1} -v --wd=\"*path*to*data*\" --input1='in1.dep' --input2='in2.dep' -o=output.dep", short_exe, name).replace("*", &sep);
