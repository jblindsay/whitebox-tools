...
impl Decrement {
    ...
    pub fn new() -> Decrement { 
        ...
        let description = "Decreases the values of each grid cell in an input raster by 1.0.".to_string();
        ...
        Decrement { name: name, description: description, parameters: parameters, example_usage: usage }
    }
}
