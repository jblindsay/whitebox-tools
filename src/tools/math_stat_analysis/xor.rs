...
/// This tool is a Boolean operator, i.e. it works on *True* or *False* (1 and 0) values. Grid cells for which 
/// THE FIRST input raster (`--input1`) has a *True* value BUT NOT THE SECOND raster (`--input2`) are assigned 
