...
impl StandardDeviationFilter {
    pub fn new() -> StandardDeviationFilter { // public constructor
        ...
        StandardDeviationFilter { name: name, description: description, parameters: parameters, example_usage: usage }
    }
}
