                    ...
                    for row in (0..rows).filter(|r| r % num_procs == tid) {
                        ...
                        for col in 0..columns {
                            for i in 0..num_files {
                                ...
                                // col_src = ((x[col as usize] - inputs[i].configs.east) / inputs[i].configs.resolution_x).round() as isize;
                    ...
                    for row in (0..rows).filter(|r| r % num_procs == tid) {
                        ...
                        for col in 0..columns {
                            ...
                            for i in 0..num_files {
                                ...
                                col_src = (x[col as usize] - inputs[i].configs.east) / inputs[i].configs.resolution_x;
