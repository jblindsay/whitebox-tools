...
impl MaxOverlay {
    pub fn new() -> MaxOverlay { // public constructor
        let name = "MaxOverlay".to_string();
        
        let description = "Evaluates the maximum value for each grid cell from a stack of input rasters.".to_string();
        ...
        MaxOverlay { name: name, description: description, parameters: parameters, example_usage: usage }
    }
}
