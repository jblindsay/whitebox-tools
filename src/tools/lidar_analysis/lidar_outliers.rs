...
impl LidarRemoveOutliers {
    pub fn new() -> LidarRemoveOutliers { // public constructor
        let name = "LidarRemoveOutliers".to_string();
        let toolbox = "LiDAR Tools".to_string();
        let description = "Removes outliers (high and low points) in a LiDAR point cloud.".to_string();
