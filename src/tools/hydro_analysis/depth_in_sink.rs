...
impl DepthInSink {
    pub fn new() -> DepthInSink { // public constructor
        ...
        parameters.push(ToolParameter{
            ...
            description: "Flag indicating whether the background value of zero should be used.".to_owned(),
        ...
        let usage = format!(">>.*{0} -r={1} -v --wd=\"*path*to*data*\" --dem=DEM.dep -o=output.dep --zero_background", short_exe, name).replace("*", &sep);
