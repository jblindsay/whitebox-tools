...
impl TangentialCurvature {
    pub fn new() -> TangentialCurvature { // public constructor
        ...
        TangentialCurvature { name: name, description: description, parameters: parameters, example_usage: usage }
    }
}
                ...
                for row in starting_row..ending_row {
                    ...
                    for col in 0..columns {
                        ...
                        if z != nodata {
                            ...
                            q = p + 1.0f64;
                            if p > 0.0f64 {
                                data[col as usize] = ((zxx * zy2 + 2.0f64 * zxy * zx * zy + zyy * zx2) / ( p * q.sqrt())).to_degrees() * 100f64;
                            }
                        }
                    }
