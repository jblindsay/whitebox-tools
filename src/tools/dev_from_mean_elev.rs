...
//     let name = "dev_from_mean_elev".to_string();
//     let description = "Calculates deviation from mean elevation.".to_string();
//     DevFromMeanElev { name: name, description: description }
// }
...
pub fn get_tool_name() -> String {
    return "dev_from_mean_elev".to_string();
}

pub fn get_tool_description() -> String {
    let s = "Calculates deviation from mean elevation.";
