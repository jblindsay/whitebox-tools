...
// pub fn read_biggeotiff<'a>(
//     file_name: &'a String,
//     configs: &'a mut RasterConfigs,
//     data: &'a mut Vec<f64>,
//     th: &'a mut ByteOrderReader,
// ) -> Result<(), Error> {

//     if std::mem::size_of::<usize>() != 8 {
//         return Err(Error::new(
//             ErrorKind::InvalidData,
//             "Error reading BigTiff format.",
//         ));
//     }

//     th.seek(4);

//     let byte_size_of_offsets = th.read_u16();

//     if th.read_u16() != 0 {
//         return Err(Error::new(
//             ErrorKind::InvalidData,
//             "The BigTiff file does not appear to be formated correctly.",
//         ));
//     }

//     let mut ifd_offset = th.read_u64() as usize;
...
//     while ifd_offset > 0 {
//         th.seek(ifd_offset);
//         let num_directories = th.read_u64();
...
//         // println!("nodata: {}", r.configs.nodata);
//         let nodata_str = format!("{}", r.configs.nodata);
//         let mut nodata_bytes = nodata_str.into_bytes();
//         // For reasons I don't fully understand, alignment errors occur
//         // if the nodata string is fewer than 4 characters. In this case
//         // we buffer the string with spaces to lengthen it.
...
//         }
//         nodata_bytes.push(0);
//         // println!("nodata_bytes: {:?}", nodata_bytes);
//         ifd_entries.push(IfdEntry::new(
//             TAG_GDAL_NODATA,
//             DT_ASCII,
