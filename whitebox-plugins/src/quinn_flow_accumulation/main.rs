...
/// portion flow (*F<sub>i</sub>*) given to each neighbour, *i*:
///
...
///
/// Where *L<sub>i</sub>* is the contour length, and is 0.5&times;grid size for cardinal directions and 0.354&times;grid size for
...
///
/// # See Also
/// `D8FlowAccumulation`, `FD8FlowAccumulation`, `DInfFlowAccumulation`, `MDInfFlowAccumulation`, `Rho8Pointer`, `WetnessIndex`
fn main() {
